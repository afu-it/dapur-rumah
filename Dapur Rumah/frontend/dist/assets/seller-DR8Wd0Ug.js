import"./globals-BEQflRq_.js";/* empty css             */import{i as o}from"./ui-DpRDf-P5.js";import{a as m}from"./api-C7O6TzkL.js";o("home");document.addEventListener("DOMContentLoaded",async()=>{const t=document.getElementById("seller-container"),s=new URLSearchParams(window.location.search).get("id");if(!s){t.innerHTML='<div style="text-align: center; padding: 4rem;"><h2>Ralat 404</h2><p>Profil peniaga tidak dijumpai.</p></div>';return}try{const a=await m(`/api/sellers/${s}`);if(a.success&&a.data)d(a.data.profile,a.data.products);else throw new Error(a.error||"Peniaga tidak dijumpai")}catch(a){t.innerHTML=`<div style="text-align: center; padding: 4rem; color: var(--error-color);"><h2>Oops!</h2><p>${a.message}</p></div>`}function d(a,i){document.title=`${a.shop_name} | Dapur Rumah`;const l=a.shop_name.charAt(0).toUpperCase(),n=a.profile_image?`<img src="${a.profile_image}" class="seller-avatar-large" alt="${a.shop_name}">`:`<div class="seller-avatar-large">${l}</div>`;let r='<div class="empty-state" style="grid-column:1/-1;text-align:center;">Tiada produk tersedia buat masa ini.</div>';i.length>0&&(r=i.map(e=>`
